      ...
      <div id="carouselExample" className="carousel slide mt-5">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src={resume1} className="d-block mx-auto" alt="Professional Business Résumé" />
            <h3>Professional Business Résumé</h3>
          </div>
          <div className="carousel-item">
            <img src={resume2} className="d-block mx-auto" alt="Max Potential Starter Résumé" />
            <h3>Max Potential Starter Résumé</h3>
          </div>
          <div className="carousel-item">
            <img src={resume3} className="d-block mx-auto" alt="Centered Balanced Résumé" />
